...
Adafruit_PWMServoDriver pca2 = Adafruit_PWMServoDriver(0x41);  // Elbow + Wrist PCA
...
void loop() {
  ...
  moveWrist2Range(0, 180, 10);  // wrist2 move up
  delay(900);

  moveWrist2Range(180, 0, 10);  // wrist2 move back down
  delay(900);
